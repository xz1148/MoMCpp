...
// the function calculats the Gaussian Legendre quadrature absiccas and wights
// between point A and point B;
// input:
// nt: number of abssicas;
// A, B: ends of segment;
// t: absciccas
// wts; weights

{
    double len_AB = abs(A-B);  //the length of segment AB
    double mid_p = (A + B)/2.0;
    double t0[nt];
    double wts0[nt];  //the orginal abssicas from -1 to 1
    ...
    // the function calculats the Gaussian Legendre quadrature absiccas and wights
{
    ...
    double kind = 1.0;
    double alpha;  // no need just as a void input
    double beta;
